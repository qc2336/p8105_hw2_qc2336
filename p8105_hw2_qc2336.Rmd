...
baseline
```
>> In this data set, the important steps are to change the binary data sex and apoe 4 into chracters. And change the age of onset into numeric data so it can drop the missing value.
