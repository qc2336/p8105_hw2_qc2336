...
baseline
```
>> In this data set, the important steps are to change the binary data into chracters. And change the age of onset into numeric data so it can drop the missing value.
...
```
>> 483 people are recruited but only 97 developed mci. The mean baseline age is 70.26.`30/46`of the women are APOE4 carriers. 
